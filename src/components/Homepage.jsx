...
import { Navbar, Services, Plans, Footer, Faqs, Hero } from "../components";
const Homepage = () => {
  return (
    <>
      <div className="w-full overflow-hidden">
        ...
        >
          <div className={`${styles.boxWidth} mb-40 md:mb-auto xs:mb-auto`}>
            <Services />
          </div>
        </div>

        <div
          className={`${styles.flexCenter} ${styles.backgroundContainer} hidden`}
        >
          <div
        ...
        <div className={`bg-gray20 sm:px-16 px-6 ${styles.flexCenter}`}>
          <div className={`${styles.boxWidth}`}>
            <Footer />
          </div>
        </div>
